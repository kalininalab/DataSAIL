...
def save_datasail_splits(base: Path, df: pd.DataFrame, key: str, techniques: List[Tuple[str, str]], e_splits: Optional[Dict] = None, inter_splits: Optional[Dict] = None) -> None:
    """
