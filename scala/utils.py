...
def call_mmseqs_clustering(env, fasta_file, output_path = None, seq_id_threshold = 0.0, silenced = False):
    ...
    cmds = [env.mmseqs2_path, 'easy-linclust', fasta_file, output_path, env.tmp_folder, '--similarity-type', '2', '--cluster-reassign', '1', '-c', '1.0', '--min-seq-id', str(seq_id_threshold)]
